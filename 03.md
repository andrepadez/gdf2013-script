...
https://github.com/pgte/gdf2013/compare/002...003

* Change index.html para:

* Mostrar o erro só se houver erro + ng-cloak
* Só mostrar "No items found" se não houver items:
...
<html lang="en" ng-app="ToodooApp">
  ...
  <body>
    ...
    <div id="error" class="container" ng-show="error" ng-cloak>
